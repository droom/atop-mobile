...
function checkPosition() {
    if (window.matchMedia('(max-width: 640px) and (max-width: 930px)').matches) {
        console.log("hey")
    } else {
        console.log("no")
    }
...
$('.feature-wrap').show();
    ...
    /*
    if (productReverse === true){
      $('td').css('color', '#f2f2f2');
      $('#lightboxTitle').css('color', '#f2f2f2');

    } else {
      $('td').css('color', '#000');
      $('#lightboxTitle').css('color', '#000');
    }
    */
